            ...
            {footerSocialLinks.map((link) => {
              return (
                <a
                  ...
                  className="size-10 rounded-lg bg-white dark:bg-gray-800 shadow-md flex items-center justify-center text-muted-foreground hover:text-blue-500 transition-colors"
                >
